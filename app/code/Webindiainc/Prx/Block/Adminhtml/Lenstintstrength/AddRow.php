...
namespace Webindiainc\Prx\Block\Adminhtml\Lenstintstrength;
...
class AddRow extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'lenstintstrength_id';
        $this->_blockGroup = 'Webindiainc_Prx';
        $this->_controller = 'adminhtml_lenstintstrength';

        parent::_construct();

        $this->buttonList->update('save', 'label', __('Save Lenstintstrength'));
        $this->buttonList->add(
            'saveandcontinue',
            [
        ...
        $model = $this->_coreRegistry->registry('row_data');
			$id = $model->getLenstintstrengthId();
			if($id) {
				$this->buttonList->add(
					'delete',
					[
