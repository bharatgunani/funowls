...
namespace Webindiainc\Prx\Block\Adminhtml\Lenstype;
...
class AddRow extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'lenstype_id';
        $this->_blockGroup = 'Webindiainc_Prx';
        $this->_controller = 'adminhtml_lenstype';

        parent::_construct();

        $this->buttonList->update('save', 'label', __('Save Lenstype'));
        $this->buttonList->add(
            'saveandcontinue',
            [
