...
namespace Webindiainc\Prx\Block\Adminhtml\Lensusage;
...
class AddRow extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'lensusage_id';
        $this->_blockGroup = 'Webindiainc_Prx';
        $this->_controller = 'adminhtml_lensusage';

        parent::_construct();

        $this->buttonList->update('save', 'label', __('Save Lensusage'));
        $this->buttonList->add(
            'saveandcontinue',
            [
