...
namespace Webindiainc\Prx\Block\Adminhtml\Lensprescription;
...
class AddRow extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'lensprescription_id';
        $this->_blockGroup = 'Webindiainc_Prx';
        $this->_controller = 'adminhtml_lensprescription';

        parent::_construct();

        $this->buttonList->update('save', 'label', __('Save Lensprescription'));
        $this->buttonList->add(
            'saveandcontinue',
            [
        ...
        $model = $this->_coreRegistry->registry('row_data');
			$id = $model->getLensprescriptionId();
			if($id) {
				$this->buttonList->add(
					'delete',
					[
