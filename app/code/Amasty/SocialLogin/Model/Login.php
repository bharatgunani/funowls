...
class Login
{
    ...
    const PWA_TOKEN_PARAM = 'generateToken';

    const PWA_TOKEN = 'token';
    ...
    public function execute(array $params): array
    {
        ...
        return $this->returnAction($isAjax, $token ?? null);
    }
    ...
    private function returnAction(bool $isAjax, ?string $token = null): array
    {
