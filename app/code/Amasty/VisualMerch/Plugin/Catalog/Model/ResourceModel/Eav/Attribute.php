...
class Attribute
{
    const CONDITION_TYPE_COMBINE = 'Amasty\VisualMerch\Model\Rule\Condition\Combine';
    const CONDITION_TYPE_PRODUCT = 'Amasty\VisualMerch\Model\Rule\Condition\Product';
